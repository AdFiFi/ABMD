...
"""
BNT is a reproduction of Brain network transformer in:
Brain network transformer
X. Kan, W. Dai, H. Cui, Z. Zhang, Y. Guo and C. Yang
Advances in Neural Information Processing Systems 2022
"""


class BNTConfig(BrainEncoderConfig):
    def __init__(self,
                 node_size,
                 sizes=(360, 100),
                 pooling=(False, True),
...
class BNT(nn.Module):
    ...
    def forward(self, node_feature: torch.tensor, **kwargs):
        ...
        logits = self.fc(node_feature.reshape(bz, -1))
